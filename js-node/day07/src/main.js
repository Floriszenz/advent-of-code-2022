...
const totalSizeOfSmallDirectories = filesystem.traverseFilesystem((sum, currentDirectory) => {
...
const totalSizeOfDirectoryToDelete = filesystem.traverseFilesystem((minimum, currentDirectory) => {
    if (currentDirectory.size >= diskSpaceThatMustBeFreed && currentDirectory.size < minimum) {
...
console.log(`Total size of directory that should be deleted: ${totalSizeOfDirectoryToDelete}`);
